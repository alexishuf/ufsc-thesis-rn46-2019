...
A classe possui apenas uma opção que fornece uma feature (english) e todas as demais servem para desativar comportamentos \textit{default}.

\paragraph*{\texttt{english}} Prepara o \abnTeX e a classe para que o corpo do documento esteja em inglês. Alguns elementos em português, especialmente os relacionados a BU e a UFSC permanecem em português.
