...
deverá ser esclarecida pela BU em breve, ocasão na qual essa classe será
atualizada.
...
do \abnTeX desaconcelha essa abordagem. Quando o \abnTeX permitir a configuração
...
que isso funcione, o .cls inicializa o \mt|\graphicspath| da seguinte forma:
...
caminhos são relativos ao working directory do \texttt{pdflatex}, não são
