...
\begin{description}
  \item[v0.10.0] (2024-10-28) ``Suporte'' a NBR 10520:2023;
...
\paragraph*{bstoverride} Para emular suporte à NBR 10520:2023, enquanto o
abntex2 não oferece esse suporte (ou enquanto uma versão do abntex2 que oferece
esse suporte não está disponível nos repositórios de pacotes ou no overleaf), a
classe extrai uma versão minimamente modificada do abntex2-alf.bst no mesmo
diretório onde está o arquivo .tex principal (o arquivo fornecido para
latexmk/pdflatex/...). Para inibir tal comportamento, utilize as opções
\lacmd{bstoverride=false} ou \lacmd{nobstoverride}. Alternativamente você pode
copiar/editar o arquivo abntex2-alf.bst, uma vez que se o arquivo já existir,
ele não será modificado ou substituído durante a compilação da classe.
