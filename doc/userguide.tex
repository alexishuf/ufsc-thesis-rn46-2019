...
completo de exemplo na \autoref{fig:preambulo}. Os próximos parágrafos. Segue um
...
\paragraph*{\lacmd{membrobanca\{<nome com
títulos>\}\{<universidade por extenso>\}}}
Nome do professor avaliador da banca, incluíndo Prof. (ou Profa.) antes do nome
e o título \textbf{após} o nome. Exemplo: \emph{Prof. Mordecai Malignatus,
  Dr.}. O orientador não deve ser incluído nessa seção. Não está claro nas
instruções da UFSC se o coorientador também não deveria. Note que esse é o único
lugar onde o título deve vir após o nome. Para orientador e coordenador a BU
coloca o título antes.

\paragraph*{\lacmd{coordenadora\{<nome>\}}} Nome do coordenador do
programa. Nesse caso a BU usa títulos antes do nome. No caso de coordenadora, o
comando \lacmd{coordenadora} pode ser usado. Exemplo: \lacmd{coordenador\{
  Prof. Dr. Mordecai Malignatus\}}.
...
\paragraph*{\lacmd{imprimirfolhadecertificacao}\\
            \lacmd{imprimirfolhadeaprovacao}
} 
...
com o comando \lacmd{membrobanca\{<nome>\}\{<universidade>\}}.
